...
class AddFriendsInput extends Component {
  render() {
    return <TextInput style={styles.usernameInput}></TextInput>;
  }
}
...
class AddFriendsSubmit extends Component {
  ...
  render() {
    return (
      <TouchableOpacity style={styles.submitUsername} onPress={this.addFriend}>
  ...
  return (
    <View style={styles.friend}>
      <View style={styles.friendFirstC}>
        <View
          style={[
            styles.friendPicture,
            { backgroundImage: 'url("' + item.image + '")' },
          ]}
        />
        <Text style={styles.friendName}>{item.name}</Text>
      </View>
      <View style={styles.sharedGames}>
        <Text style={styles.sharedGamesText}>{item.sharedgames}</Text>
      </View>
    </View>
  );
}
